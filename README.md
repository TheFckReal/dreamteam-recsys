...
### Этап 2: Разведочный анализ данных (EDA) (до 2 ноября 23:59 2025)
...
### Этап 4: Базовый сервис (до конца декабря)

* Базовый сервис (реализующий минимальную функциональность: инференс модели или аналог)
* Подготовка отчета и презентации.

### Промежуточная защита (начало января 2026)

### Этап 5: Нелинейные ML-модели (до конца января 2026)
...
### Этап 6: Создание сервиса с имплементацией лучшего ML-решения (до конца февраля 2026)

### Этап 7: Внедрение Deep Learning (до конца марта - начала апреля 2026)


### Этап 8: Доработка задачи: улучшение сервисной части по обратной связи от команды курса П.Р.; тюнинг DL-моделей и выбор лучшего решения overall (до середины мая 2026)
